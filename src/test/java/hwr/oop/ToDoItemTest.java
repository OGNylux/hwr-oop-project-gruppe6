...
class ToDoItemTest {
    ...
    @Test
    void toStringTest() {
        ToDoItem item = new ToDoItem("Finish Math homework", "I need to do tasks 5 - 10b. Look up on pages 36 and 42 in Analysis I. ", "Uni", false, Priority.MEDIUM,  new Project("test"));
    ...
    void getCreatedAtTest() {
        ToDoItem item = new ToDoItem("Finish Math homework", "I need to do tasks 5 - 10b. Look up on pages 36 and 42 in Analysis I. ", "Uni", false, Priority.HIGH,  new Project("test"));
    ...
    void getProjectNameTest() {
        ToDoItem item = new ToDoItem("", "", "", false, Priority.LOW, new Project("test"));
    ...
    void setProjectNameTest() {
        ToDoItem item = new ToDoItem("", "", "", false, Priority.LOW, new Project(""));
        String test = "test";
