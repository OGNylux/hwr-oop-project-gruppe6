...
class ToDoItemTest {
    ...
    @Test
    void getTitleTest() {
        ToDoItem item = new ToDoItem("testTitle", "testDesc", "testTag", false, Priority.LOW, EstimatedTime.LONG, new Project("test"));
    ...
    void setEstimatedTimeTest(){
        ...
        EstimatedTime testEstimatedTime = item.getEstimatedTime();
        assertThat(testEstimatedTime).isEqualTo(EstimatedTime.LONG);
    }
    @Test
    void setTagTest() {
        ToDoItem item = new ToDoItem("testTitle", "testDesc", "testTag", false, Priority.LOW, EstimatedTime.LONG, new Project("test"));
    ...
    @Test
    void toStringTest() {
        ToDoItem item = new ToDoItem("Finish Math homework", "I need to do tasks 5 - 10b. Look up on pages 36 and 42 in Analysis I. ", "Uni", false, Priority.MEDIUM, EstimatedTime.LONG, new Project("test"));
    ...
    void getCreatedAtTest() {
        ToDoItem item = new ToDoItem("Finish Math homework", "I need to do tasks 5 - 10b. Look up on pages 36 and 42 in Analysis I. ", "Uni", false, Priority.HIGH, EstimatedTime.LONG, new Project("test"));
    ...
    void getProjectNameTest() {
        ToDoItem item = new ToDoItem("", "", "", false, Priority.LOW, EstimatedTime.LONG, new Project("test"));
    ...
    void setProjectNameTest() {
        ToDoItem item = new ToDoItem("", "", "", false, Priority.LOW, EstimatedTime.LONG, new Project(""));
        String test = "test";
