...
class ToDoItemTest {
    ...
    @Test
    void getIdTest() {
        ToDoItem item = new ToDoItem(0,"testTitle", "testDesc", "testTag", false, Priority.LOW,  new Project("test"), LocalDate.now());
    ...
    @Test
    void toStringTest() {
        ToDoItem item = new ToDoItem(0,"Finish Math homework", "I need to do tasks 5 - 10b. Look up on pages 36 and 42 in Analysis I. ", "Uni", false, Priority.HIGH,  new Project("test"), LocalDate.now());
    ...
    void getCreatedAtTest() {
        ...
        System.out.println(result);
        assertThat(item.getCreatedAt()).contains(result);
    }
    @Test
    void getDeadline() {
        ToDoItem item = new ToDoItem(0,"testTitle", "testDesc", "testTag", false, Priority.LOW,  new Project("test"), LocalDate.now());
    ...
    void getProjectNameTest() {
        ToDoItem item = new ToDoItem(0,"", "", "", false, Priority.LOW, new Project("test"), LocalDate.now());
    ...
    void setProjectNameTest() {
        ToDoItem item = new ToDoItem(0,"", "", "", false, Priority.LOW, new Project(""), LocalDate.now());
        String test = "test";
