...
public class ListJsonTest {
    ...
    public void listToJsonTest() {
        ...
        ToDoItem item = new ToDoItem("Finish Math homework", "I need to do tasks 5 - 10b.", "Uni", false, Priority.HIGH, EstimatedTime.LONG, new Project(""));
        ToDoItem item2 = new ToDoItem("Calculate Something", "More Math over here", "Math", false, Priority.MEDIUM, EstimatedTime.LONG, new Project(""));
